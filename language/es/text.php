...
$hesklang['signature_long']='¡La firma del usuario es demasiado larga! Por favor, límite la firma a 1000 caracteres';
...
$hesklang['cat_intro']='Aquí puede gestionar las categorías. Las categorías son útiles
para organizar los tickets por relevancia (por ejemplo &quot;Ventas&quot;,
...
$hesklang['users_intro']='Aquí puede administrar los usuarios que pueden acceder al panel de administración y
responder tickets. Los administradores pueden ver/editar tickets en cualquier categoría y tienen acceso
a todas las funciones del panel de administración (administrar usuarios, administrar categorías, ...) mientras
que otros usuarios sólo pueden ver y responder tickets que se encuentren dentro de su propia categoría';
$hesklang['yes']='SI';
$hesklang['no']='NO';
...
$hesklang['signature_max']='Firma (maximo 1000 caracteres)';
...
$hesklang['kb_intro']='La base de conocimiento es un conjunto de respuestas a las preguntas más frecuentes (FAQ) y artículos que proporcionan recursos de autoayuda para sus clientes.
Una amplia y bien escrita base de conocimiento (KB) puede reducir drasticamente el número de tickets de soporte que recibe y ahorra una puede optimizar gran cantidad de su tiempo. Puede organizar los artículos en categorías
y subcategorías.'; // Description in ADMIN panel
$hesklang['kb_is']='La base de conocimiento es una colección de respuestas por categorías a las preguntas mas frecuentes (FAQ) y artículos de su interés. Usted puede leer los artículos en esta categoría o seleccionar una subcategoría en la que Usted se interese.'; // Description for CUSTOMERS
...
$hesklang['kb_private2']='artículos privados solo pueden ser leídos por el personal.';
$hesklang['kb_draft']='Borrador';
$hesklang['kb_draft2']='El artículo ha sido guardado pero no se ha publicado aun. Este solo puede ser leído por el personal <br />que tiene permiso para administrar los artículos de la base de conocimientos (KB).';
$hesklang['kb_links']='<i><span class="notice"><b>¡Peligro!</b></span><br />¡Introduzca un código válido sin etiquetas &lt;head&gt; y &lt;body&gt; , solo contenido!</i>';
...
$hesklang['admin_can']='(acceso a todos las características y categorías)';
...
$hesklang['kbpart']='Lo sentimos, Usted no tiene permisos para accesar a este artículo';
$hesklang['popart']='Articulos destacados';
$hesklang['latart']='Ultimos articulos';
$hesklang['m']='Mas asuntos';
$hesklang['ac']='Articulos de esta categoría';
$hesklang['noa']='No hay artículos todavía';
$hesklang['noac']='No hay artículos todavía en esta categoría';
$hesklang['dta']='Fecha de alta';
$hesklang['ad']='Detalles del articulo';
...
$hesklang['opt2']='Opciones para este radio button, introducir una por línea (cada línea creará un nuevo valor radio button a elegir). ¡Debe introducir al menos dos opciones!';
...
$hesklang['opt4']='Opciones para esta casilla, introducir una opción por linea. Cada linea sera una opción que los clientes pueden elegir, son posibles múltiples opciones.';
...
$hesklang['s_mlange']='Si se habilita sus usuarios podrán acceder al centro de soporte en cualquiera de los idiomas instalados. ¡Habilitar solo si ofrece soporte en todos los idiomas instalados!';
$hesklang['s_inl']='Probar carpeta de idiomas';
$hesklang['s_inle']='Comprobacion de la carpeta de idiomas para ver si son válidos. Solo se instalan correctamente los idiomas que superan todas las pruebas.';
...
$hesklang['dmod']='El modo de depuración está habilitado. Asegúrese de desactivar el modo de depuración en la configuración una vez Hesk esta instalado y funcióna correctamente.';
...
$hesklang['tlo']='Bloquear (Lock) ticket';
...
$hesklang['support_remove']='Una gran cantidad de esfuerzo, tiempo y dinero fue invertido en el desarrollo de HESK. Por favor, apoya el proyecto HESK para comprar una licencia que eliminará también los enlaces <i>Powered by Help Desk Software HESK&trade;</i> de su servicio de soporte';
...
$hesklang['yhbb']='Usted ha sido bloqueado por el sistema por %s minutos debido a intentos de acceso fallidos al sistema.';
...
$hesklang['kw1']='(opciónal - separado por un espacio, una coma o una nueva línea)';
...
$hesklang['beta']='(VERSIoN DE PRUEBA)';
$hesklang['maxpost']='Probablemente has intentado enviar mas datos de los que este servidor acepta.<br /><br />Por favor, intente enviar el formulario de nuevo con menos datos o sin ellos.';
...
$hesklang['resim']='<b>¡Ingrse su nueva contraseña en el formulario de abajo!</b>';
...
$hesklang['nkba']='Búsquedas en la Base de Conocimientos requiere de suficientes artículos únicos para que funcione correctamente.<br /><br />Considere agregar más artículos a la base de conocimientos para mejorar los resultados de búsqueda y artículos de sugerencias.';
...
$hesklang['scoy']='¿Estas seguro de que quiere asignartelo a ti mismo?';
...
$hesklang['re_confirm2']='Habilitar esto también habilitara "Requerir correo electrónico" en "Funciones". ¿Proceder?';
...
$hesklang['select_category_text']='¿En que podemos ayudarle?';
...
$hesklang['d_ci']='SOLO PARA USUARIOS AVANZADOS: Un formato de fecha PHP válido, consulte el manual de PHP.';
$hesklang['cf_noe']='Introduzca una dirección de correo electrónico válida en <i>%s</i>';
$hesklang['cf_noem']='Introduzca una o mas direcciones de correo electrónico válidas en <i>%s</i>';
...
$hesklang['hni3']='Para instalar HESK, sigue las <a class="link" href="docs/">Instrucciones en la documentacion</a>';
$hesklang['cf']='Carpeta de caché';
$hesklang['e_cdir']='Hesk no sera capaz de analizar correos electrónicos o resultados de caché a menos que la carpeta de caché exista y sea escribible.';
...
$hesklang['lwidtall']='Utilicer todo el ancho disponible';
...
$hesklang['follow_up_email']='Sea honesto - ¿cómo lo hemos hecho?';
...
$hesklang['mfa_verification_email_intro']='Se ha enviado un correo electrónico a <strong>%s</strong> con un código de verificación de seis dígitos. Introduzca el código que has recibido por correo electrónico a continuación para continuar.'; // %s = User's email address
...
$hesklang['mfa_verification_auth_app_cant_scan']='¿No puedes escanear la imagen? Introduzca manualmente este código en su dispositivo: <b>%s</b>'; // %s = Secret code
...
$hesklang['mfa_backup_codes_num']='Puede obtener un nuevo conjunto de 10 códigos de reserva cuando lo desees. Cuando creas un nuevo juego de códigos, el antiguo queda automáticamente inactivo.';
...
$hesklang['email_to_ticket_info']='La conversión de los correos electrónicos en tickets requiere una configuración del lado del servidor. Para más detalles, consulta <a href="%s" target="_blank">esta guía de la base de conocimientos</a>.'; // %s = link to article
...
$hesklang['epdd']='Error al analizar el parámetro due_date:';
...
$hesklang['customer_accounts_required_to_submit']='<strong>Habilitado: obligatorio para los tickets</strong> (solo los clientes que hayan iniciado sesión pueden enviar tickets de soporte)';
$hesklang['customer_accounts_required']='<strong>Habilitado: obligatorio para acceder</strong> (solo los clientes que hayan iniciado sesión pueden acceder al servicio de asistencia y a la base de conocimientos)';
...
$hesklang['customer_accounts_reg_staff']='Solo el personal puede registrar cuentas de clientes';
...
$hesklang['customer_forgot_password']='¿Olvidó su contraseña?';
...
$hesklang['customer_login_remember_just_email']='Recordar solo mi correo electrónico';
...
$hesklang['deleting_customer_delete_tickets']='Eliminar tickets';
$hesklang['deleting_customer_anonymize_tickets']='Anonimizar tickets';
$hesklang['deleting_customer_retain_tickets']='Conservar tickets';
...
$hesklang['import_customer_step3_complete']='¡El proceso de importación está completo!';
...
$hesklang['e_c_email']='Ingrese la dirección de correo electrónico correcta para ver este ticket';
...
$hesklang['cf_limit_all']='Has alcanzado el límite de campos personalizados y no puedes crear nuevos campos personalizados.';
...
$hesklang['seq_id_numeric']='La búsqueda de número de ticket debe contener solo números';
